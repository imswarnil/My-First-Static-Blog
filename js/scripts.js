...
(function ($) {
 ...
 $('.panel-collapse').on('show.bs.collapse', function () {
  ...
  $('.panel-collapse').on('hide.bs.collapse', function () {
    ...
    /*Donate Box start Sweet Alert */ 
   document.getElementById('donate').onclick = function(){
    Swal.fire({
     
      imageUrl: 'images/donate.jpg',
      imageWidth: 380,
      imageHeight: 380,
      imageAlt: 'QR Code Is Not Available',
      animation: true,
      showCloseButton: true,
      confirmButtonText:'<a class="white-text" href="donate.html#sponsor"> <i class="fa fa-users"></i> People Who Donated </a>',
      footer: '<a href ="donate.html"> Why I should Donate ? </a>'
    })
  };
   /*Donate Box end Sweet Alert */ 
